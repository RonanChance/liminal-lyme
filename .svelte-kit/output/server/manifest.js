	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/credits/get/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/message/create/_server.js'))
			},
			{
				id: "/api/message/list",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/message/list/_server.js'))
			},
			{
				id: "/api/run/create",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/run/create/_server.js'))
			},
			{
				id: "/api/run/retrieve",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/run/retrieve/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/thread/create/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/thread/delete/_server.js'))
			},
			{
				id: "/auth",
				pattern: /^\/auth\/?$/,
