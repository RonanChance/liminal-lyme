...
<div class="relative z-10 mt-[1px]">
...
<div class="pt-12 sm:pt-[5%] xl:pt-[5%] ml-4 rotating-text relative flex flex-col overflow-hidden">
    ...
    <div class="mt-4 pt-6 sm:mt-[5%] xl:mt-[5%] mb-9 mr-4 relative rounded-lg bg-[var(--lightbackground)] sm:max-w-[80%] sm:mx-auto">
