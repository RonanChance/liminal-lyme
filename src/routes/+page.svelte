...
<div class="flex flex-col">
    <div class="flex flex-col md:flex-row bg-[var(--lightbackground)] pb-6" in:fly={{y:50, duration: 450}}>
        <div class="flex flex-row md:flex-col items-center mt-6 pl-[2%] pr-[2%]" in:blur={{duration: 450}}>
        ...
        <div class="flex flex-row md:flex-col items-center mt-6 md:mb-0 pl-[2%] pr-[2%]" in:blur={{duration: 450}}>
            <div class="min-w-[50%] max-w-[50%] md:min-w-[70%] md:max-w-[70%] xl:min-w-[60%] xl:max-w-[60%] 2xl:min-w-[40%] 2xl:max-w-[40%]">
