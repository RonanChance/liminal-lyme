...
<div class="pt-6 pb-6 px-4 rotating-text relative">
    ...
    <h1 class="leading-tight tracking-wide md:text-center">Optimize<br />Tick-Borne Illness<br />Recovery</h1>
    <h3 class="pt-6 pb-6 md:text-center">Medications and supplements should improve your health, not set you back.</h3>
    <button id="scrollDown" class="whitebutton flex flex-row gap-2 h-[50px] justify-center items-center w-full sm:w-[200px] sm:mx-auto sm:hidden" type="button">
        <ArrowDownSolid class="w-7 h-7 pb-[3px]"/> 
        Get Started
    </button>
</div>

<div class="pt-6 mb-9 relative mx-4 rounded-lg bg-[var(--lightbackground)] md:max-w-[80%] md:mx-auto">
    ...
    <div class="pt-6 text-center flex flex-col md:flex-row justify-center items-center gap-6 bg-[var(--lightbackground)]" in:blur={{duration: 300}}>
