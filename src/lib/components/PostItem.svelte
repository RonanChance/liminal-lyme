...
<Modal bind:showModal>
	...
	<div class="buttonList">
		<a class="whitebutton rounded-lg" href="https://www.google.com/search?q={clickedItem}" target="_blank">
		...
		<a class="whitebutton rounded-lg" href="https://amazon.com/s?k={clickedItem}" target="_blank">
