...
<div class="flex flex-col items-center text-center justify-center bg-[var(--lightbackground)] pt-10 pb-14">
    ...
    <div class="pt-10">
        <div class="text-[var(--white)] text-base">
            <ul class="ml-16 relative list-none StepProgress">
                ...
                <div class="StepProgress-item relative current mr-5 font-light"><span class="text-xl font-normal">Launch a Survey Research Study</span><br /><span class="italic opacity-90">Correlate medications, supplements, and treatments with tick-borne illness outcomes</span></div>
            </ul>
        </div>
    </div>
    ...
    <div class="flex gap-1 justify-center w-[90%] md:w-[65%] lg:w-[50%] xl:w-[30%] px-4 pt-8">
        ...
        <button class="whitebutton text-white" onclick={onSubmit} >
